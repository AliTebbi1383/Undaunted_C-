...
Q_CONSTINIT static const uint qt_meta_data_CLASSpage2ENDCLASS[] = {
 ...
 // slots: parameters
    ...
    QMetaType::Void,
    QMetaType::Void,
    QMetaType::Bool, QMetaType::QString, 0x80000000 | 7,    6,    8,
...
Q_CONSTINIT const QMetaObject page2::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSpage2ENDCLASS_t,
        ...
        // method 'validateLiveUsername1'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'validateLiveUsername2'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void page2::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->validateLiveUsername1(); break;
        case 2: _t->validateLiveUsername2(); break;
        case 3: { bool _r = _t->validateUsername((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString&>>(_a[2])));
